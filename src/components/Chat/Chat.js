...
const Chat = () => {
  ...
  const sampleQuestions = [
    {
      text: "Suggest some fun facts",
      icon: <GoLaw className="sample-question-icon" />,
    },
    {
      text: "Top tourist destinations in Europe",
      icon: <GoLaw className="sample-question-icon" />,
    },
    {
      text: "translate this sentence into French: 'I love learning new languages'",
      icon: <GoLaw className="sample-question-icon" />,
    },
    {
      text: "Compare the features of iPhone 14 and Samsung Galaxy S21",
      icon: <GoLaw className="sample-question-icon" />,
    },
  ];
